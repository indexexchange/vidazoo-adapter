...
var PartnerSpecificValidator = require('vidazoo-htb-validator.js');
...
function VidazooHtb(configs) {
    ...
    */
    ...
    (function __constructor() {
        ...
        __profile = {
            partnerId: 'VidazooHtb', // PartnerName
            namespace: 'VidazooHtb', // Should be same as partnerName
            statsId: 'VIZO', // Unique partner identifier
            version: '2.0.0',
            targetingType: 'slot',
            enabledAnalytics: {
                requestTime: true
